...
const NOSOURCE_MSG: &'static str = "No configured source of trusted entropy";
...
impl rand_core::RngCore for EntropyRng {
    fn next_u32(&mut self) -> u32 {
        match self.rng {
            #[cfg(feature = "rdseed_entropy")]
            EntropySource::RdSeed(ref mut rng) => return rng.next_u32(),
            #[cfg(feature = "jitter_entropy")]
            EntropySource::Jitter(ref mut rng) => return rng.next_u32(),
            #[cfg(feature = "rdrand_entropy")]
            EntropySource::RdRand(ref mut rng) => return rng.next_u32(),
        }
        #[cfg(not(any(
            feature = "rdseed_entropy",
            feature = "jitter_entropy",
    ...
    fn next_u64(&mut self) -> u64 {
        match self.rng {
            #[cfg(feature = "rdseed_entropy")]
            EntropySource::RdSeed(ref mut rng) => return rng.next_u64(),
            #[cfg(feature = "jitter_entropy")]
            EntropySource::Jitter(ref mut rng) => return rng.next_u64(),
            #[cfg(feature = "rdrand_entropy")]
            EntropySource::RdRand(ref mut rng) => return rng.next_u64(),
        }
        #[cfg(not(any(
            feature = "rdseed_entropy",
            feature = "jitter_entropy",
    ...
    fn fill_bytes(&mut self, _dest: &mut [u8]) {
        match self.rng {
            #[cfg(feature = "rdseed_entropy")]
            EntropySource::RdSeed(ref mut rng) => return rng.fill_bytes(_dest),
            #[cfg(feature = "jitter_entropy")]
            EntropySource::Jitter(ref mut rng) => return rng.fill_bytes(_dest),
            #[cfg(feature = "rdrand_entropy")]
            EntropySource::RdRand(ref mut rng) => return rng.fill_bytes(_dest),
        }
        #[cfg(not(any(
            feature = "rdseed_entropy",
            feature = "jitter_entropy",
    ...
    fn try_fill_bytes(&mut self, _dest: &mut [u8]) -> core::result::Result<(), rand_core::Error> {
        match self.rng {
            #[cfg(feature = "rdseed_entropy")]
            EntropySource::RdSeed(ref mut rng) => return rng.try_fill_bytes(_dest),
            #[cfg(feature = "jitter_entropy")]
            EntropySource::Jitter(ref mut rng) => return rng.try_fill_bytes(_dest),
            #[cfg(feature = "rdrand_entropy")]
            EntropySource::RdRand(ref mut rng) => return rng.try_fill_bytes(_dest),
        }
        #[cfg(not(any(
            feature = "rdseed_entropy",
            feature = "jitter_entropy",
